...
<p>Что нужно было сделать:<p>
<ol>
  <li>На основе данных за прошлый месяц посчитать и выделить лучших менеджеров, учитывая:<a>1.Процент выполненного плана;<a>2.Процента прироста этого года к прошлому; <a> 3.Сумма продаж новых клиентов, которых привел менедежр</li>
</ol>
